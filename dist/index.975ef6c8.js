...
var _imgApi = require("./js/img-api");
...
function onSubmitBtn(evt) {
    ...
    let currentPage1 = 1;
    if (!valueSearch) return (0, _notiflixNotifyAio.Notify).failure("Enter your search details.");
    (0, _imgApi.serviceSearchImg)(currentPage1, valueSearch).then((data)=>{
        quantityImg += data.hits.length;
        createCards(data.hits);
        refs.containerCards.insertAdjacentHTML("beforeend", createCards(data.hits));
        if (data.totalHits !== 0) (0, _notiflixNotifyAio.Notify).info(`"Hooray! We found ${data.totalHits} images."`);
        if (data.totalHits > quantityImg) refs.btnLoadMor.classList.replace("load-more-hidden", "load-more");
        ...
        (0, _notiflixNotifyAio.Notify).failure(error.message);
    }).finally(()=>{
        gallery.refresh();
    });
}
...
function onClickBtnLoadMor() {
    ...
    currentPage += 1;
    (0, _imgApi.serviceSearchImg)(currentPage, inputValue).then((data)=>{
        quantityImg += data.hits.length;
        createCards(data.hits);
        refs.containerCards.insertAdjacentHTML("beforeend", createCards(data.hits));
        if (data.totalHits <= quantityImg) refs.btnLoadMor.classList.replace("load-more", "load-more-hidden");
    }).catch((error)=>{
        (0, _notiflixNotifyAio.Notify).failure(error.message);
    }).finally(()=>{
        gallery.refresh();
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","./js/img-api":"86Iy5","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"86Iy5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "serviceSearchImg", ()=>serviceSearchImg);
var _notiflixNotifyAio = require("notiflix/build/notiflix-notify-aio");
...
async function serviceSearchImg(currentPage, valueSearch) {
    ...
    try {
        ...
        if (response.data.total === 0) (0, _notiflixNotifyAio.Notify).failure("Sorry, there are no images matching your search query. Please try again.");
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
